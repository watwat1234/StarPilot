    ...
    def _build_view(self):
        ...
        self._hud_rows = [
            ...
            SettingRow("BlindSpotMetrics", "toggle", tr_noop("Blind Spot Borders"),
                       ...
                       enabled=bsm,
                       visible=hud_on),
            SettingRow("BlindSpotIcon", "toggle", tr_noop("Blind Spot Icon"),
                       subtitle="",
                       get_state=lambda: self._params.get_bool("BlindSpotIcon"),
                       set_state=lambda s: self._params.put_bool("BlindSpotIcon", s),
                       enabled=bsm,
                       visible=hud_on),
